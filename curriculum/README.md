...
2. Copy templates:
   ...
   cp templates/curriculum/module-metadata-template.yaml curriculum/<role-slug>/modules/module-01/metadata.yaml
   cp templates/curriculum/project-metadata-template.yaml curriculum/<role-slug>/projects/project-01/metadata.yaml
   ```
...
- **Asset Metadata (`modules/*/metadata.yaml`, `projects/*/metadata.yaml`)**: Schema-compliant descriptors validated via `./tools/curriculum.py validate-metadata`.
